...
public abstract class PagSeguro {
    ...
    public static PagSeguro instance() {
        return instance(new JSEHttpClient(), new DefaultCredentialProviderChain().getCredential(), new DefaultEnvironmentProviderChain().getEnvironment());
    }
    ...
    public static PagSeguro instance(HttpClient httpClient) {
        return instance(httpClient, new DefaultCredentialProviderChain().getCredential(), new DefaultEnvironmentProviderChain().getEnvironment());
    }
    ...
    public static PagSeguro instance(Credential credential, PagSeguroEnv environment) {
        return instance(new JSEHttpClient(), credential, environment);
    }
     ...
     * @return Pagseguro instance built
     */
    public static PagSeguro instance(HttpClient httpClient, Credential credential, PagSeguroEnv environment) {
        switch (environment) {
            case PRODUCTION:
