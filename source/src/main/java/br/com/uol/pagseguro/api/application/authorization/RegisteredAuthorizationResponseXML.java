...
/**
 * Implementation of {@code RegisteredAuthorization} and
 * {@code XMLUnmarshallListener}
 *
 * @author PagSeguro Internet Ltda.
 */
@XmlRootElement(name = "authorizationRequest")
public class RegisteredAuthorizationResponseXML implements RegisteredAuthorization, XMLUnmarshallListener {
	...
	public String getRedirectURL() {
		return String.format(Endpoints.AUTHORIZATION_REDIRECT_URL, pagSeguro.getHostRedirect(), getCode());
	}
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof RegisteredAuthorizationResponseXML))
			return false;
	...
	public String toString() {
		return "RegisteredAuthorizationResponseXML{" + "code='" + code + '\'' + ", date=" + date + ", redirectURL='"
				+ redirectURL + '\'' + '}';
	}
