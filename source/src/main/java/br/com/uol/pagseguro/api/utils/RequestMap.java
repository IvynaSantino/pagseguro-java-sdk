...
/**
 * Class used to convert the data on a map to pass the parameters of the
 * requests in api
 *
...
public final class RequestMap {
	 ...
	 *
	 * @param map
	 *            Map to pass the parameters of the requests in api
	 */
