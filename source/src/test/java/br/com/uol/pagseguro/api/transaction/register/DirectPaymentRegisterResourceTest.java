...
public class DirectPaymentRegisterResourceTest extends Resource4Test {
    ...
    public void shouldOnlineDebitRegister() throws IOException, ParseException {
        HttpResponse response = new HttpResponse(200, responseAsString);
        when(httpClient.execute(any(HttpMethod.class), anyString(), anyMap(), any(HttpRequestBody.class))).thenReturn(response);
        TransactionDetail transactionDetail = directPaymentRegisterResource.withOnlineDebit(new BankBuilder().withName(BankName.Name.BANCO_DO_BRASIL));
        assertTransaction(transactionDetail);
    }
    ...
    private void assertTransaction(TransactionDetail transactionDetail) throws ParseException {
        ...
        assertEquals(TransactionType.Type.CHECKOUT, transactionDetail.getType());
        assertEquals(TransactionStatus.APPROVED, transactionDetail.getStatus());
        ...
        assertEquals("https://sandbox.pagseguro.uol.com.br/checkout/payment/booklet/print.jhtml?c=acd4738c97f8b820e520ecf89a91fcdaf60c854f561a578e283eb2ec83d636b354bccc7cb28b2554", transactionDetail.getPaymentLink());
