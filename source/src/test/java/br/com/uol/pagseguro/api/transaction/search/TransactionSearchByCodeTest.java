...
public class TransactionSearchByCodeTest extends Resource4Test {
    ...
    public void shouldSearch() throws Exception {
        ...
        assertEquals(TransactionStatus.UNRECOGNIZED, transactionDetail.getStatus());
        ...
        assertEquals(ShippingType.Type.PAC, transactionDetail.getShipping().getShippingType().getType());
        assertEquals(new BigDecimal(9.99).setScale(2, RoundingMode.HALF_EVEN), transactionDetail.getShipping().getCost());
        assertEquals(dateFormat.parse("2016-11-09 23:59:59"), transactionDetail.getLastEvent());
        assertEquals(TransactionPaymentMethod.Type.CREDIT_CARD, transactionDetail.getPaymentMethod().getType());
        assertEquals(TransactionPaymentMethod.Code.VISA, transactionDetail.getPaymentMethod().getCode());
        assertEquals(new BigDecimal(9.99).setScale(2, RoundingMode.HALF_EVEN), transactionDetail.getGrossAmount());
        assertEquals(new BigDecimal(9.99).setScale(2, RoundingMode.HALF_EVEN), transactionDetail.getDiscountAmount());
        assertEquals(new BigDecimal(9.99).setScale(2, RoundingMode.HALF_EVEN), transactionDetail.getFeeAmount());
        assertEquals(new BigDecimal(9.99).setScale(2, RoundingMode.HALF_EVEN), transactionDetail.getNetAmount());
        assertEquals(new BigDecimal(9.99).setScale(2, RoundingMode.HALF_EVEN), transactionDetail.getExtraAmount());
